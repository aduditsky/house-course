...
export default function Map({ setDataBounds, houses, highlightedId }: IProps) {
  ...
  const [viewport, setViewport] = useLocalState<ViewState>("viewport", {
    latitude: 56.01398832254167,
    longitude: 92.8679512215417,
    zoom: 13,
  });
  ...
  return (
    <div className="text-black relative">
      <ReactMapGL
        ...
        minZoom={5}
        maxZoom={15}
        // mapStyle="maxbox://styles/leighhalliday/ckhjaksxg0x2v19s1ovps41ef"
        onLoad={() => {
          if (mapRef.current) {
      ...
      >
        ...
        {houses.map((house) => (
          <Marker
            ...
            offsetLeft={-15}
            offsetTop={-15}
            className={highlightedId === house.id ? "marker-active" : undefined}
          >
            <button
